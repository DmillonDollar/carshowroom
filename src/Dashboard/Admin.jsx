    ...
    <div>
      ...
      <div className='flex  flex-wrap gap-14 justify-center'>
              ...
              <div className=' w-[30%] flex border-2 border-black p-3  bg-black text-white flex-col items-center gap-9 rounded-md'>
                          ...
                          <div className=' flex'>
                            <h1 className=' text-2xl'>No of Car Blogs<FaPen className='inline text-2xl m-6 text-[#FF4500]'/></h1>
                          </div> 
          ...
          <div className=' w-[30%] flex border-2 border-black p-3  bg-black text-white flex-col items-center gap-9 rounded-md'>
                 ...
                 <div className=' flex'>
                   <h1 className=' text-2xl'>No of Cars<FaCarAlt className='inline text-2xl m-6 text-[#FF4500]'/></h1>
                  </div> 
          ...
          <div className=' w-[30%] flex border-2 border-black p-3  bg-black text-white flex-col items-center gap-9 rounded-md'>
                  ...
                  <div className=' flex'>
                    <h1 className=' text-3xl'>No of Users<FaUser className='inline text-2xl m-6 text-[#FF4500]'/></h1>
                   </div> 
           ...
           <div className=' w-[30%] border-2 border-black p-3  bg-black text-white  gap-9 rounded-md'>
                  <Link to= '/admin/orders'className='flex flex-col items-center'>
                      <div className=' flex'>
                        <h1 className=' text-2xl'>No of Orders<FaShoppingCart className='inline text-2xl m-6 text-[#FF4500]'/></h1>
                      </div> 
